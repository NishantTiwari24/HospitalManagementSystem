	...
	<div class="main-content">
		...
		<div class="panel receptionist-list">
			...
			<div class="panel-header">
				...
				<a href="${pageContext.request.contextPath}/Admin/AddReceptionist.jsp" class="add-btn">
					<i class="fas fa-plus"></i> Add Receptionist
				</a>
			</div>
			<form method="get"
				action="${pageContext.request.contextPath}/Admin/ReceptionistList">
			...
			<div class="user-table">
				<table>
					...
					<tbody>
						<c:forEach var="sp" items="${searchreceptionist}">
							<tr>
								...
								<td>
									<form id="form-${sp.userId}" method="post"
										action="${pageContext.request.contextPath}/Admin/ReceptionistListUpdate">
