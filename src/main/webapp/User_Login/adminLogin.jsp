		...
		<div class="container">
			...
			<nav class="nav">
				<ul class="nav-list">
					...
					<li class="nav-item"><a href="${pageContext.request.contextPath}/User_Login/adminLogin.jsp" class="nav-link active">Admin</a></li>
	...
	<div class="main-content">
		<div class="login-container">
			...
			<form action="<%=request.getContextPath()%>/UserLogin" method="post">
				<input type="hidden" name="loginFrom" value="admin" /> <label
