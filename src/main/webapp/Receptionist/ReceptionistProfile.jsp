...
<body>
	...
	<div class="content">
		...
		<div class="profile-container">
			...
			<h2 class="profile-name">Recp. ${receptionists.firstName}
				${receptionists.lastName}</h2>
			<p class="profile-email">${receptionists.email}</p>
			...
			<div class="details-grid">
				...
				<div class="detail-item">
					<label>First Name</label> <input type="text" name="firstName"
						value="${receptionists.firstName}" required /> <input type="hidden"
						name="userId" value="${receptionists.userId}" />
				</div>

				<div class="detail-item">
					<label>Last Name</label> <input type="text" name="lastName"
						value="${receptionists.lastName}" required />
				</div>

				<div class="detail-item">
					<label>Address</label> <input type="text" name="address"
						value="${receptionists.address}" required />
				</div>

				<div class="detail-item">
					<label>Date of Birth</label> <input type="date" name="dob"
						value="${receptionists.dateOfBirth}" required />
				</div>

				<div class="detail-item">
					<label>Phone</label> <input type="text" name="contact_num"
						value="${receptionists.phone}" required />
				</div>
				...
				<div class="detail-item readonly">
					...
					<div class="readonly-box">
						<i
							class="fas ${receptionists.gender == 'Male' ? 'fa-mars' : receptionists.gender == 'Female' ? 'fa-venus' : 'fa-genderless'}"></i>
						<span>${receptionists.gender}</span>
					</div>
				</div>
				...
				<div class="detail-item readonly">
					...
					<div class="readonly-box">
						<i class="fas fa-building"></i> <span>${receptionists.role}</span>
					</div>
				</div>
				...
				<div class="detail-item readonly">
					...
					<div class="readonly-box">
						<i class="fas fa-id-badge"></i> <span>${receptionists.bloodGroup}</span>
					</div>
				</div>
		...
		<form id="passwordUpdateForm"
			action="${pageContext.request.contextPath}/Receptionist/PasswordUpdate"
			method="post" class="profile-details"
			style="display: none; margin-top: 20px;">
			<input type="hidden" name="userId" value="${receptionists.userId}" />
			<div class="detail-item">
